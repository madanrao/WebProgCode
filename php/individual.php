...
$check = true;
$result = mysql_query("select movie_name from view_rating_movie where movie_id=$movie_id and cust_id=$cust_id and date<CURDATE()");
...
{
echo "<span class='cool-style'>You can't rate a movie before you watch it!</span>";
}
?>
</td>
</tr>
